...
namespace JHTools {
    /// <summary>
    /// Allows objects to be assigned to unity inspector fields based on their interface
    /// implementation via drag-n'-drop. Use by adding a child class of InterfaceField
    /// where T is the interface to use.
    /// Note that this class does not magically allow interfaces to be serialized - it
    /// simply uses reflection to determine if the target object implements the interface
    /// before serializing it as a unity Object.
    /// </summary>
